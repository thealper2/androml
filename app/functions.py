permissions_list = ['SEND_SMS', 'READ_PHONE_STATE', 'GET_ACCOUNTS', 'RECEIVE_SMS',
...
api_call_signatures = ['transact', 'onServiceConnected', 'bindService', 'attachInterface',
...
columns = ['filename', 'transact', 'onServiceConnected', 'bindService',
